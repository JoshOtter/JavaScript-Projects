...
var Instruments = ["Hurdy Gurdy", "Nyckelharpa", "Tagelharpa", "Jouhikko", "Ocarina"]; // Declares the array and assigns its elements
...
var MMOs = ["Final Fantasy XIV", "Guild Wars 2", "Elder Scrolls Online", "Crowfall", "Albion Online", "World of Warcraft", "New World"] // Defines a new array object and provides its values.
function array_Function() { // Declares the function
    document.getElementById("Array").innerHTML = "Some of my favorite MMOs include " + MMOs[0] + ", " + MMOs[1] + ", and " + MMOs[3] + "."; //Sends a concatenated string including three elements from the MMOs array
}

function constant_function() { // Declares the function
    const Cat = {breed:"Norwegian Forest Cat", color:"black", age:1}; // Declares and defines an constant with several key value pairs
...
function blockVariable() { // Declares the function
    var son = "Ender"; // Defines the variable son with function scope
    {
        let son = "Iden"; // Defines the variable son with block scope
...
let cat = { // Declares the object
    breed: "Norwegian Forest Cat ", // Sets the value of one of the object's properties
    color: "black ", // Sets the value of one of the object's properties
    age: "2 ", // Sets the value of one of the object's properties
    personality: "shy ", // Sets the value of one of the object's properties
    name: "Midnight ", // Sets the value of one of the object's properties
